function 小号30胜()  --7图片参数 可认输
s胜 = 0

closeApp("com.demea.conur")
mSleep(2000)
flag = appIsRunning("com.coalition.rencounter")
mSleep(1000)

if flag == 0 then --如果没有运行
  闪退次数=闪退次数+1
  runApp("com.coalition.rencounter") --运行
...
if s胜>=30 then   --假如胜利场数达到UI里面设置的胜场数
  mSleep(100)
  可领奖7()
  可领奖=0
  mSleep(ttt)
